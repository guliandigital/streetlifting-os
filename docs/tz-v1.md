...
Версия: 1.0
Дата: 2026-04-26
Статус: историческое ТЗ V1. V1 shipped; активный roadmap см. [current-implementation-plan.md](current-implementation-plan.md).

---

## 0. Метаинформация документа

Данное ТЗ было каноническим документом для старта V1-разработки. После релиза V1 GA оно остаётся архивом требований и решений, но активный план реализации ведётся в [current-implementation-plan.md](current-implementation-plan.md). Все технические детали, типы данных, бизнес-правила, decisions и т.д. зафиксированы в подчинённых документах (см. §16).
...
При расхождении: [current-implementation-plan.md](current-implementation-plan.md) имеет приоритет для roadmap и очередности реализации; подчинённые документы детализируют исторические требования V1. При технических расхождениях источник истины — последний по версии документ.
